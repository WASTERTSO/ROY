...
OWNER_USERNAME = getenv("OWNER_USERNAME", "tso_king")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "sukuna_godxbot")
...
LOGGER_ID = int(getenv("LOGGER_ID", "-4109126820"))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "6094430636"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/wastertso/ROY",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/lovelifexd)
